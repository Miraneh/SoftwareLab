...
- اصل Interface segregation principle: این اصل می‌گوید که بهره‌بردن از چند اینترفیس کوچک و باز جزئیات، بهتر از بهره‌بردن از یک اینترفیس کلی است چراکه بعضی از کلاس‌ها ممکن است نیازی به استفاده از همه‌ی فیلدها و متدهای موجود در یک اینترفیس کلی نداشته‌باشند. این مشکل در کد ما از اول وجود نداشته‌است.
